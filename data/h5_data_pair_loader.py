...
class DataPairLoader:
    ...
    def __init__(self, h5_path_1, h5_path_2, split_1, split_2,
        ...
        self.loader_1 = DataLoader(h5_path_1, 0, batch_size, split=split_1, whole_batches=whole_batches)
        self.loader_2 = DataLoader(h5_path_2, 1, batch_size, split=split_2, whole_batches=whole_batches)
